		...
		<div id="body" class="home">
			<div class="header">
				<div>
					...
					<ul>
						<li>
							<a href="projects.php"><img src="images/project-image1.jpg" alt=""></a>
						</li>
						<li>
							<a href="projects.php"><img src="images/project-image2.jpg" alt=""></a>
						</li>
						<li>
							<a href="projects.php"><img src="images/project-image3.jpg" alt=""></a>
						</li>
						<li>
							<a href="projects.php"><img src="images/project-image4.jpg" alt=""></a>
						</li>
					</ul>
				</div>
			</div>
				...
				<div>
					<ul>
						<li>
							...
							<a href="blog.php"><img src="images/mars-rover.jpg" alt=""><span></span></a>
						</li>
						<li>
							<h1>LATEST BLOG</h1>
							<ul>
								<li>
									<a href="blog.php"><img src="images/finding-planet.jpg" alt=""></a>
									<h1>FINDING PLANET X-123</h1>
									<span>FEBRUARY 6, 2023</span>
									<a href="blog.php" class="more">Read More</a>
								</li>
								<li>
									<a href="blog.php"><img src="images/new-satellitedish.jpg" alt=""></a>
